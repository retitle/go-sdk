...
func TestTransactionsGetDetail(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.TransactionsData())
...
func TestTransactionsGetMulti(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.TransactionsListData())
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
	trxId := "10"
...
func TestTransactionsCreate(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.TransactionsCreateResponseData())
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestTransactionsAvailablePartyRoles(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.TransactionsAvailablePartyRolesResponseData())
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestTransactionsOrgsTransactionsIds(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.OrgsTransactionsIdsData())
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestTransactionsDeletedParties(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.DeletedPartiesData())
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
	trxId := "10"
...
func TestTransactionsFields(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.FieldsResponseData())
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
	trxId := "10"
...
func TestTransactionsFolderCreates(t *testing.T) {
	...
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
	trxId := "10"
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.FolderCreatesResponseData(trxId))
...
func TestTransactionsFolderRenames(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.FolderRenamesResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestTransactionsFormImports(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.FormImportsResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestItemDeletes(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.ItemDeletesResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestLinkListingInfo(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.LinkListingInfoResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestPartyCreates(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.PartyCreatesResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestPartyInvites(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.PartyInvitesResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestPartyPatches(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.PartyPatchesResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestPartyRemoves(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.PartyRemovesResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestPartyUpdateContactDetails(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.PartyUpdateContactDetailsResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestReorderFolders(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.ReorderFoldersResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestTransactionDocumentAssignments(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.TransactionDocumentAssignmentsResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestTransactionDocumentRenames(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.TransactionDocumentRenamesResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestTransactionDocumentRestores(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.TransactionDocumentRestoresResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestTransactionDocumentTrashes(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.TransactionDocumentTrashesResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestUpdateArchivalStatus(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.UpdateArchivalStatusResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
...
func TestUpdateTransactionMeta(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.UpdateTransactionMetaResponseData(trxId))
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
