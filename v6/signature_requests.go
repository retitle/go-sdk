...
type SignatureRequestsResource interface {
	...
	ListTransactions(opts ...core.RequestOption) (*TransactionFilterOptionsResponse, error)
...
func (r signatureRequestsResourceImpl) FlowSendRevision(signatureRequestReviseRequest SignatureRequestReviseRequest, opts ...core.RequestOption) (*SignatureRequestFlowSendRevisionResponse, error) {
	res := SignatureRequestFlowSendRevisionResponse{}
	if err := r.client.Post(&res, true, fmt.Sprintf("/signature_requests/flow_send_revision"), signatureRequestReviseRequest, opts...); err != nil {
		return nil, err
	}
	return &res, nil
}

func (r signatureRequestsResourceImpl) ListTransactions(opts ...core.RequestOption) (*TransactionFilterOptionsResponse, error) {
	res := TransactionFilterOptionsResponse{}
	if err := r.client.Get(&res, true, fmt.Sprintf("/signature_requests/list_transactions"), opts...); err != nil {
		return nil, err
	}
	return &res, nil
}
