...
type TransactionFilterOption struct {
	Title         string `json:"title,omitempty"`
	TransactionId string `json:"transaction_id,omitempty"`
	Object        string `json:"object,omitempty"`
}

func (m TransactionFilterOption) IsRef() bool {
	return strings.HasPrefix(m.Object, "/ref/")
}

type TransactionFilterOptionsResponse struct {
	Data   []*TransactionFilterOption `json:"data,omitempty"`
	Object string                     `json:"object,omitempty"`
}

func (m TransactionFilterOptionsResponse) IsRef() bool {
	return strings.HasPrefix(m.Object, "/ref/")
}
