...
func TestContactsGetDetail(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.ContactWithoutAddress())
...
func TestContactsGetMulti(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.ContactList())
	err := fixtures.PartyError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
	contactId := "10"
...
func TestContactsCreate(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.ContactCreateResponseData())
...
func TestUpdateContact(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.ContactUpdateResponse())
	err := fixtures.TransactionsError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
