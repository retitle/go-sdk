...
func TestPartiesGetDetail(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.PartyData())
...
func TestPartiesGetMulti(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.PartyListData())
	err := fixtures.PartyError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
	partyId := "10"
	trxId := "10"
