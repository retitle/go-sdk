...
func TestTransactionDocumentsGetDetail(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.TransactionDocumentData())
...
func TestTransactionDocumentsGetMulti(t *testing.T) {
	...
	stringReadCloser = tests_utils.ParseStructToIoReadCloser(fixtures.TransactionDocumentListData())
	err := fixtures.TransactionDocumentError()
	errStringReadCloser = tests_utils.ParseStructToIoReadCloser(&err)
	trxDocId := "10"
	trxId := "10"
